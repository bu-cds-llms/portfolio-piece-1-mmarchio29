...
**Methods:** I implemented scaled dot-product attention and multi-head self-attention from scratch to directly inspect queries, keys, values, and attention weights. I embedded a short sentence (in English) to produce interpretable heatmaps.
